...
func (m *MatchPredicate) Validate() error {
	...
	case *MatchPredicate_DestinationClusterMatch:
		...
		{
			tmp := m.GetDestinationClusterMatch()

			if v, ok := interface{}(tmp).(interface{ Validate() error }); ok {

				if err := v.Validate(); err != nil {
					return MatchPredicateValidationError{
						field:  "DestinationClusterMatch",
						reason: "embedded message failed validation",
						cause:  err,
					}
				}
...
// Validate checks the field values on ClusterMatch with the rules defined in
// the proto definition for this message. If any rules are violated, an error
// is returned.
...
// ClusterMatchValidationError is the validation error returned by
// ClusterMatch.Validate if the designated constraints aren't met.
...
// Field function returns field value.
func (e ClusterMatchValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e ClusterMatchValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e ClusterMatchValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e ClusterMatchValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e ClusterMatchValidationError) ErrorName() string { return "ClusterMatchValidationError" }

// Error satisfies the builtin error interface
func (e ClusterMatchValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = ClusterMatchValidationError{}
